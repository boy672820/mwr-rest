...
export class RoutineService {
    ...
    async getRoutineDate(block_id: number): Promise<RoutineDateEntity> {
        return await this.routineDateRepository.findOne({
            block_id: block_id,
        })
    }
    ...
    async createExerciseSet(
        data: RoutineCreateSetDTO,
    ): Promise<RoutineSetsEntity> {
    ...
    async updateBlock(data: RoutineUpdateBlockDTO): Promise<any> {
        return await this.blockRepository.update(
            {ID: data.ID},
    ...
    async removeBlockAndDate(id: number): Promise<any> {
        ...
        await this.routineDateRepository
            .createQueryBuilder()
            .delete()
