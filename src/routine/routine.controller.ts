...
export class RoutineController {
    ...
    @Get('date/:block_id')
    async getRoutineDate(@Param() {block_id}): Promise<RoutineDateEntity> {
        return this.routineService.getRoutineDate(block_id)
    }
    ...
    @Post('block')
    async createBlock(
        @Body() data: RoutineBlockDTO,
    ): Promise<RoutineBlockEntity> {
